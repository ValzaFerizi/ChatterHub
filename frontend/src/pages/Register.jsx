      ...
      <div className="panel" style={{width:'100%',maxWidth:'420px'}}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{marginBottom:'16px'}}>
            ...
            <input type="text" name="first_name" value={form.first_name} onChange={handleChange} style={{width:'100%',padding:'10px 12px',border:'1px solid #d1d5db',borderRadius:'6px',fontSize:'14px',boxSizing:'border-box'}} placeholder="First Name" required />
          </div>
          <div style={{marginBottom:'16px'}}>
            <label style={{display:'block',marginBottom:'6px',fontWeight:'600',fontSize:'14px'}}>Last Name</label>
            <input type="text" name="last_name" value={form.last_name} onChange={handleChange} style={{width:'100%',padding:'10px 12px',border:'1px solid #d1d5db',borderRadius:'6px',fontSize:'14px',boxSizing:'border-box'}} placeholder="Last Name" required />
          </div>
          <div style={{marginBottom:'16px'}}>
        ...
        <p style={{textAlign:'center',marginTop:'20px',fontSize:'14px',color:'#6b7280'}}>
          Have an account? <a href="/login" style={{color:'#6d28d9',fontWeight:'600'}}>Login</a>
        </p>
      </div>
    </div>
  )
